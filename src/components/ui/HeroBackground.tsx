  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(0, 82, 255, 0.10) 0%, transparent 70%)',
        }}
      />
      ...
      {/* Orb 3 — center, very subtle, adds depth */}
      <div
      ...
      {/* Noise texture overlay for depth — bumped from 0.015 to 0.025 */}
      <div
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent, rgba(0, 82, 255, 0.12), transparent)',
        }}
      />
    </div>
  );
